...
$\ce{PaCO2}$ and log a$[\ce{HCO}_{3}^-]$) is an almost linear one, the goal is to arrive at a mathematical description of this relationship and to investigate its departure from linearity. The mathematical technique
...
$\ce{pH}$, log $\ce{PaCO2}$ and log a$[\ce{HCO}_{3}^-]$ values from the same
...
$\ce{PaCO2}$ and log a$[\ce{HCO}_{3}^-]$ from the same patients as the
*ELIbe* data set.
...
sets consist of $\ce{pH}$, log $\ce{PaCO2}$ and log a$[\ce{HCO}_{3}^-]$ values
...
![](figures/H_02_image2.png){width="100%"}
...
calculated PC3 value of a $\ce{pH}$, log $\ce{PaCO2}$, log a$[\ce{HCO}_{3}^-]$
...
![](figures/H_02_image5.png){width="50%"} \
...
$\ce{PaCO2}$ as well as a$[\ce{HCO}_{3}^-]$, while only two of these
...
$\ce{pH}$, log $\ce{PaCO2}$ and log a$[\ce{HCO}_{3}^-]$ data set, PC3 must be
...
combination of $\ce{pH}$, $\ce{PaCO2}$ and a$[\ce{HCO}_{3}^-]$ is not valid.
...
within the 95% reference interval is only possible for data sets of $\ce{pH}$, log $\ce{PaCO2}$ and log a$[\ce{HCO}_{3}^-]$, since the variance in PC3
...
to calculate a$[\ce{HCO}_{3}^-]$ or $\ce{BE}$ from measured $\ce{pH}$, $\ce{PaCO2}$
