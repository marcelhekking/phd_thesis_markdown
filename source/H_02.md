...
*Figure 2--1. Three-dimensional view of a rotated $\mathit{pH}$, $\mathit{PaCO_2}$ and base excess ($\mathit{BE}$) data set. The cube represents the 95% reference volume as
