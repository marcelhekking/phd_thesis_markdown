...
carbon dioxide $\ce{CO2}$ in arterial blood ($\ce{PaCO}_{2}$) for the evaluation of
the respiratory component, and either the arterial bicarbonate-ion
($\ce{HCO3-}$) concentration ($\ce{a[HCO3^-]}$) or the
...
*Figure 2--1. Three-dimensional view of a rotated $\ce{pH}$, $\mathit{PaCO}_{2}$ and base excess ($\ce{BE}$) data set. The cube represents the 95% reference volume as
defined by the 95% univariate reference intervals of Error: Reference
source not found.*

Figure 2 --1 displays such a $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ distribution in three dimensions. The distribution is rotated in such a way that the curved
...
intervals for $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ of Table 2--1.

Having observed that the relationship between the arterial acid-base
variables (both for combinations of $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ and $\ce{pH}$, log
$\ce{PaCO}_{2}$ and log a\[$\ce{HCO}_{3}^{-}$\]) is an almost linear one, the goal is to arrive at a mathematical description of this relationship and to investigate its departure from linearity. The mathematical technique
...
of $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ values from patients of the respiratory ICU of the
...
*OLVGbe* contains 1500 unselected combinations of $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$
...
$\ce{pH}$, log $\ce{PaCO}_{2}$ and log a\[$\ce{HCO}_{3}^{-}$\] values from the same
patients as the *OLVGbe* data set. Data set *SKZbe* contains 1500
combinations of $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ values from patients of the neonatal
...
*ELIbe* contains 1500 unselected combinations of $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$
...
sets consist of $\ce{pH}$, log $\ce{PaCO}_{2}$ and log a\[$\ce{HCO}_{3}^{-}$\] values
...
Since the plane of measurements in case of a $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ data set
...
illustrate the slight curvature of a PCA transformed $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ data set which is absent in a PCA transformed $\ce{pH}$, log PaCO2 and log
...
calculated PC3 value of a $\ce{pH}$, log $\ce{PaCO}_{2}$, log a\[$\ce{HCO}_{3}^{-}$\]
...
percentage of explained variance by PC3 in data sets of $\ce{pH}$, log $\ce{PaCO}_{2}$
and log a\[$\ce{HCO}_{3}^{-}$\] (data sets *OLVGab* and *ELIab*) may
be attributed to rounding effects and analytical imprecision. For the
other data sets, consisting of $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ values, the curvature
...
acid-base laboratory values; each transformed combination of $\ce{pH}$, $\ce{PaCO}_{2}$
and a\[$\ce{HCO}_{3}^{-}$\]/$\ce{BE}$ must lead to a small PC3 value. For a
$\ce{pH}$, log $\ce{PaCO}_{2}$ and log a\[$\ce{HCO}_{3}^{-}$\] data set, PC3 must be
...
combination of $\ce{pH}$, PaCO­~2~ and a\[$\ce{HCO}_{3}^{-}$\] is not valid.
...
within the 95% reference interval is only possible for data sets of $\ce{pH}$,
...
PaCO­­~2~ and $\ce{BE}$ are located on a slightly curved plane of measurements,
...
check the plausibility of a transformed $\ce{pH}$, $\ce{PaCO}_{2}$ and $\ce{BE}$ combination
...
to calculate a\[$\ce{HCO}_{3}^{-}$\] or $\ce{BE}$ from measured $\ce{pH}$, $\ce{PaCO}_{2}$
...
with which the a\[$\ce{HCO}_{3}^{-}$\] or the $\ce{BE}$ are calculated. The
