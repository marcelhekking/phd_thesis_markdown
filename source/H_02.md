...
![](source/figures/H_02_image1.png){width="6.45625in"height="4.461111111111111in"}
...
median.![](source/figures/H_02_image2.png){width="5.419444444444444in"
height="4.447222222222222in"}![](media/image6.wmf){width="5.4125in"
...
illustrate the slight curvature of a PCA transformed pH, $\ce{PaCO}_{2}$ and BE
data set which is absent in a PCA transformed pH, log PaCO2 and log
a\[$\ce{HCO}_{3}^{-}$\] data
set.![](media/image8.wmf){width="6.495138888888889in"
height="3.1020833333333333in"}![](media/image9.wmf){width="6.495138888888889in"
...
representation.![](media/image11.wmf){width="5.785416666666666in"
